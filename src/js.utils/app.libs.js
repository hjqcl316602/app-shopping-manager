...
LibArrays.prototype.index = function(ary, fn) {
  if( !this.isArray(ary) || ary.length == 0 ) return false;
  let index = -1;
...
// 4. 中文、数字、字母组成的用户名！
LibValids.prototype.isUserName = function(o) {
  let regEn = /^[\u4E00-\u9FA5A-Za-z0-9]+$/;
  return regEn.test(o)
}

// 5.  数字
LibValids.prototype.isNumbers = function(o) {
  let regEn = /^[0-9]+$/;
  return regEn.test(o)
}
// 5.  中文字符
LibValids.prototype.isCN = function(o) {
  let regEn = /^[\u4e00-\u9fa5]+$/;
  return regEn.test(o)
}
